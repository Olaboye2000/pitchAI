...
│   │   ├── page.tsx           # Main UI with form, pitch display, and CopilotKit integration
│   │   ├── layout.tsx         # App layout with CopilotKit provider
│   │   └── globals.css        # Neobrutalism design system styles
│   ├── mastra/
│   │   ├── agents/
│   │   │   └── index.ts       # Pitch agent definition with instructions
│   │   ├── tools/
│   │   │   ├── researchTool.ts       # Brave Search API + HTML cleaning
│   │   │   ├── pitchFormatterTool.ts # LLM-powered pitch structuring
│   │   │   └── generateLogoTool.ts   # Logo generation
